          ...
          >
            <div className="px-4 py-4">
              <div className="space-y-1 flex flex-col">
                ...
                <Link to="/manifesto" className="text-white block px-3 py-4 text-base font-medium tracking-widest uppercase hover:bg-white/5 rounded-xl transition-colors">Manifesto</Link>
              </div>
            </div>
          </motion.div>
        )}
